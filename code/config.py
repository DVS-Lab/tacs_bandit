...
# E-field simulation output (generated by the SimNIBS pipeline in
# ~/Desktop/projects/tacs_bandit/simNIBS, then copied here). Generated output,
# not raw data.
#
# There were previously two copies of this file — data/ and data/bandit/ — read
# by different notebooks and free to drift apart. This constant is the single
# path; point new code at it rather than composing one.
#
# Values from 2026-08-16 onward are simulated at 750/250 uA peak amplitude. The
# earlier file used 1500/500 (peak-to-peak), making every magnitude exactly 2x
